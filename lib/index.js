...
// per Vision docs: https://cloud.google.com/vision/docs/reference/rest/v1/images/annotate
...
// todo - issue #1 reimplement localFile request
// accepts a relative image path and returns a promise of base64 encoded image data
// function convertLocalImage(imagePath = '../content/smiling.jpg') {
//   imagePath = path.join(__dirname, imagePath);
//
//   return new Promise((resolve, reject) => {
//     fs.readFile(imagePath, (err, data) => {
//       if (err) return reject(new Error('could not read file', err));
//
